          ...
          <div className="flex justify-between">
            ...
            <div className="relative inline-block w-full">
              <select
                ...
                className="block w-full px-4 py-2 pr-10 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              >
