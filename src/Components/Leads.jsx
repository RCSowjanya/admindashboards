      ...
      <div className="flex gap-3 max-[1100px]:flex-col">
        ...
        <div className="w-1/2 h-full border border-[#7A7A7A] max-[1100px]:w-full rounded-lg ">
          <div className="flex justify-between mb-4 bg-blue-100 px-5 py-3">
            <div className="">
              <h5 className=" text-[12px] font-[500]">Amazon Solar</h5>
              <p className="text-[14px] text-[#4348BD] font-[500]">Solar</p>
            </div>
            ...
            <div className="flex gap-2">
              ...
              <div>
                <a href="#">
                  <button className="bg-green-400 border py-2 px-4 text-white rounded-md">
                    Approve
                  </button>
                </a>
              </div>
