      ...
      <div className="flex gap-3 max-[1100px]:flex-col">
        ...
        <div className="w-1/2 h-full border border-[#7A7A7A] max-[1100px]:w-full rounded-lg px-[1%] py-[5%]">
          <div className="flex justify-between mb-4">
            <p className="text-[22px] font-[600] text-[#000]">All Users</p>
        ...
        <div className="w-1/2 h-full border border-[#7A7A7A]  max-[1100px]:w-full  rounded-lg  ">
          <div className="flex justify-between mb-4 bg-blue-100 px-5 py-3">
            <div className="">
              <h5 className=" text-[12px] font-[500]">Name</h5>
              <p className="text-[14px] text-[#4348BD] font-[500]">Rounak</p>
            </div>
            <div className="">
              <h5 className="text-[12px] font-[500]">Email</h5>
